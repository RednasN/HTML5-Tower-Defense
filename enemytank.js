function EnemyTank(imageIndex, lives, reward) {
    ...
    this.draw = function() {
        ...
        twdGrid.render(twdImages.enemies[this.imageIndex].images[this.angle], Math.round(this.drawx) + mainCanvasXOffset, Math.round(this.drawy) + mainCanvasYOffset)
    }
    ...
    this.calculate = function() {
        ...
        if(Math.abs(this.drawx-twdGrid.route[this.routeindex].drawx) < 5
        ...
        {                      
           ...
           if(this.routeindex - 1 >= 0)
            {
                if(twdGrid.route[this.routeindex-1].y != twdGrid.route[this.routeindex + 1].y &&
                    twdGrid.route[this.routeindex-1].x != twdGrid.route[this.routeindex + 1].x)
                {
                    this.docurve = true;
                    this.isRight = true;
        ...
        if(!this.docurve)
        {
            if (this.drawx + mainCanvasXOffset > twdGrid.route[this.routeindex].drawx + mainCanvasXOffset) {
            ...
            if (this.drawy + mainCanvasYOffset > twdGrid.route[this.routeindex].drawy + mainCanvasYOffset) {
