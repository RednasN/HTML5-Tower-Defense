...
export class TowerDefenseGrid {
  ...
  public drawAssets(): void {
    if (this.selectedCell != null) {
      const drawAssetx = this.selectedCell.drawx + this.canvasState.mainCanvasXOffset;
      const drawAssety = this.selectedCell.drawy + this.canvasState.mainCanvasYOffset;
        ...
        for (let y = 0; y < this.grid_height; y++) {
          ...
          if (imageIndex !== null) {
            this.render(
              ...
              this.grid[x][y].drawx + this.canvasState.mainCanvasXOffset,
              this.grid[x][y].drawy + this.canvasState.mainCanvasYOffset
            );
          }
        }
      }
