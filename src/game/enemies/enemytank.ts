...
export class EnemyTank {
    ...
    constructor(twdImages: TowerDefenseImages, canvasState: TwdCanvasState, twdGrid: TowerDefenseGrid, twdGameLoop: GameLoop, reward: number, lives: number, imageIndex: number) {               
    ...
    public draw(): void{
        ...
        this.twdGrid.render(this.twdImages.enemies[this.imageIndex].images[this.angle], Math.round(this.drawx) + this.canvasState.mainCanvasXOffset, Math.round(this.drawy) + this.canvasState.mainCanvasYOffset)
    }
    ...
    public calculate(): void {
        ...
        if(Math.abs(this.drawx-this.twdGrid.route[this.routeindex].drawx) < 5
        ...
        {                      
           ...
           if(this.routeindex - 1 >= 0)
            {
                if(this.twdGrid.route[this.routeindex-1].y != this.twdGrid.route[this.routeindex + 1].y &&
        ...
        if(!this.docurve)
        {
            if (this.drawx +  this.canvasState.mainCanvasXOffset > this.twdGrid.route[this.routeindex].drawx + this.canvasState.mainCanvasXOffset) {
            ...
            if (this.drawy + this.canvasState.mainCanvasYOffset > this.twdGrid.route[this.routeindex].drawy + this.canvasState.mainCanvasYOffset) {
