...
export class MultiRocket {
    ...
    constructor(gameLoop: GameLoop, canvasState: TwdCanvasState, twdImages: TowerDefenseImages, twdGrid: TowerDefenseGrid, x: number, y: number, enemyIndex: number, bulletIndex: number, angle: number, damage: number, fixedangletime: number, shootingdelay: number) {
